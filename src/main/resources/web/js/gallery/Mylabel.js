 ...
 * 3. rendering mold (@see mold/gallery.js )
 ...
 *
 */
gallery.Mylabel = zk.$extends(zul.Widget, {
	...
	*/
	bind_: function () {
		 ...
		 */
		this.$supers(gallery.Mylabel,'bind_', arguments);
	...
	*/
	unbind_: function () {
		...
		*/
		this.$supers(gallery.Mylabel,'unbind_', arguments);
	},
	/*
